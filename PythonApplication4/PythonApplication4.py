...
def zamok():
    ...
    print("451 - один номер правильный но не на месте")
    print("473 - один номер правильный но не на месте")
    print("278 - один номер правильный и на месте")
    print("295 - два номера правильные и на месте")
    print("478 - нет правильных номеров")
    otv=str(input("Введите ответ: "))
    if otv=="235":
        print("Вы смогли выйти из палатки!")
...
def death():
    ...
    exit()
def loooool ():
    print ("Вы попадаете в карманное помещение... внутри темно... вы не знаете что делать, однако вы чувствуете что демон рядом.")
    time.sleep (1)
    print ("ВЫ идетё всё глубже и глубже, пока не находите огромное помощение с стором рядом и... на нём сидит капибара, она одета как маг... кажется она хочет чтобы вы ответили на загадку")
    time.sleep (1)
    print ("Вы не знаете почему вы почувствовали о загадке,однако у вас в голове возникает вопрос")
    time.sleep (1)
    print ("Что можно ждать, но когда оно наступит то будет уже сегодня?")
    time.sleep (1)
    otv2=str(input("Введите ответ: "))
    if otv2=="Завтра":
        print("Вы прошли и снова стоите рядом с демоном")
    else:
        death()
def yes ():
    print ("Вы остаётесь в поле, однако ваша голова кружится, как вы попробуете прийти в себя?")
    time.sleep (1)
    print ("1 Попытаться махать наугад, демон рядом... 2 попробовать встряхнуть головой... 3 закричать")
    otv3=str(input("Введите ответ: "))
    if otv3=="2":
        print("Вы смогли прийти в себя")

    else:
        death()
def game():
    print("Резко в ваших глазах темнеет и...")
...
time.sleep(2)
print ("Вам надо выбраться из палатки, для этого надо угадать код")
zamok()
